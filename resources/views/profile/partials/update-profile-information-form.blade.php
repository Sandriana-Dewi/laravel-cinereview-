<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Perbarui informasi profil akun, alamat email, dan foto profil Anda.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="flex items-center gap-4 mt-2">
                @if($user->avatar)
                    <img src="{{ asset('storage/' . $user->avatar) }}" class="w-16 h-16 rounded-full object-cover border border-gray-300">
                @else
